...
from sister.sensors import desis
...
def main():
    ...
    if 'PRS' in args.l1_zip:
        prisma.he5_to_envi(args.l1_zip,args.out_dir,args.temp_dir,args.elev_dir,
                           shift = args.shift,match=args.match,proj = args.proj,
                           res = args.res)

    elif 'DESIS' in args.l1_zip:
        desis.geotiff_to_envi(args.l1_zip,args.out_dir,args.temp_dir,args.elev_dir,
                           match=args.match,proj = args.proj,res = args.res)
